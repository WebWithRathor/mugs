...
export default function HeroSection() {
  return (
    <section className="flex flex-col lg:flex-row items-center justify-center lg:justify-between py-20 bg-white">
      <div className="text-center lg:text-left max-w-lg">
        <p className="text-lg font-bold mb-2">Hi I am</p>
        <h1 className="text-xl font-bold text-orange-500">Muhammad Umair</h1>
        <h2 className="text-6xl font-black mt-2">UI & UX <br /> <span className='inline-block ml-32'>Designer</span></h2>
        ...
        <button className="mt-6 px-10 py-2 bg-orange-500 text-white rounded-md  hover:bg-orange-600 transition">
          Hire Me
        </button>
      </div>
      ...
      <div className="relative mt-10 lg:mt-0">
        ...
        <div className="flex w-96 justify-center mt-5 space-x-4 text-gray-600">
